...
def main():
    p = argparse.ArgumentParser(prog="tvbxmax",
    ...
    if args.cmd == "serve":
        import uvicorn
        from tvb_xmax.api import app
        uvicorn.run(app, host="0.0.0.0", port=8088)
    elif args.cmd == "agents":
        from tvb_xmax.community import run_bot
        import os
        token = os.environ.get("TVBXMAX_DISCORD_TOKEN", "")
        from tvb_xmax.community.discord_bot import OpenClawAgent
        agents = [
