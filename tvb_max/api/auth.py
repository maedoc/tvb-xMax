...
DB_PATH = os.environ.get("TVBMAX_DB", "tvbmax.db")
JWT_SECRET = os.environ.get("TVBMAX_JWT_SECRET", secrets.token_hex(32))
JWT_TTL = 3600 * 24  # 24h
...
def _hash_pw(pw: str) -> str:
    return hashlib.pbkdf2_hmac("sha256", pw.encode(), b"tvbmax-salt", 100000).hex()
